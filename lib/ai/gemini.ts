...
export async function analyzeCertificate({ data, mimeType }: { data: string; mimeType: "application/pdf" | "image/png" | "image/jpeg" | "image/webp" }): Promise<CertificateAnalysis> {
