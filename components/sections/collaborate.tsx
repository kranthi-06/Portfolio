...
import { collaborate, personal } from "@/lib/content";
    ...
    >
      <div className="container">
        <div className="grid lg:grid-cols-[1fr_1fr] gap-16 lg:gap-24 items-start">
          <Reveal>
            <p className="eyebrow mb-6">{collaborate.eyebrow}</p>
            <h2 id="collaborate-title" className="section-title mb-6">
              {collaborate.title}
            </h2>
            <p className="section-subtitle mb-10">{collaborate.subtitle}</p>

            <div className="space-y-3">
              {collaborate.channels.map((channel) => {
