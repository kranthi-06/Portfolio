...
export function GitHubSection() {
  ...
  const githubLink = socialLinks.find(l => l.name.toLowerCase() === "github");
  const profileUrl = githubLink?.url || githubData.profileUrl;
  const username = profileUrl.split("/").pop() || githubData.username;
